          ...
          element={
            <>
              <div className="fixed top-6 right-6 z-[100] flex items-center gap-2">
                ...
                <Link
                  to="/tasks/image-normalization"
                  className="w-12 h-12 bg-white text-slate-700 rounded-2xl shadow-xl shadow-slate-200 border border-slate-200 hover:text-green-600 hover:scale-105 transition-all flex items-center justify-center group"
